...
export const REALTIME_CALIBRATION = {
  ...
  stripes: [
    ...
    { note: "D4", polygon: [[25, 119.5], [34, 120.5], [14.5, 133.5], [4.5, 132.5]], segment: "left", stripeIndex: 3 },
    { note: "Eb4", polygon: [[34, 120.5], [43, 121], [25, 134], [14.5, 133.5]], segment: "left", stripeIndex: 4 },
    { note: "E4", polygon: [[43, 121], [53, 121.5], [34.5, 135], [25, 134]], segment: "left", stripeIndex: 5 },
    { note: "F4", polygon: [[53, 121.5], [62, 122], [44.5, 136], [34.5, 135]], segment: "left", stripeIndex: 6 },
    { note: "F#4", polygon: [[62, 122], [71.5, 122.5], [55.5, 136.5], [44.5, 136]], segment: "left", stripeIndex: 7 },
    { note: "G4", polygon: [[71.5, 122.5], [81, 123], [66, 137], [55.5, 136.5]], segment: "left", stripeIndex: 8 },
    { note: "Ab4", polygon: [[81, 123], [91, 123.5], [76.5, 138], [66, 137]], segment: "left", stripeIndex: 9 },
    { note: "A4", polygon: [[91, 123.5], [100, 124.5], [87.5, 138.5], [76.5, 138]], segment: "left", stripeIndex: 10 },
    { note: "Bb4", polygon: [[100, 124.5], [110, 125], [99, 139], [87.5, 138.5]], segment: "left", stripeIndex: 11 },
    { note: "B4", polygon: [[110, 125], [120, 125.5], [110, 140], [99, 139]], segment: "left", stripeIndex: 12 },
    { note: "C5", polygon: [[120, 125.5], [129.5, 126], [121, 141], [110, 140]], segment: "left", stripeIndex: 13 },
    { note: "C#5", polygon: [[129.5, 126], [139.5, 126.5], [132, 141.5], [121, 141]], segment: "left", stripeIndex: 14 },
    { note: "D5", polygon: [[139.5, 126.5], [149, 127], [143, 142], [132, 141.5]], segment: "left", stripeIndex: 15 },
    { note: "Eb5", polygon: [[149, 127], [159, 127.5], [154, 143], [143, 142]], segment: "left", stripeIndex: 16 },
    { note: "E5", polygon: [[159, 127.5], [169, 128.5], [165, 144.5], [154, 143]], segment: "left", stripeIndex: 17 },
    { note: "F5", polygon: [[169, 128.5], [178, 129.5], [176, 146.5], [165, 144.5]], segment: "left", stripeIndex: 18 },
    { note: "F#5", polygon: [[278, 137.5], [287, 138.5], [302.5, 156], [292.5, 155]], segment: "right", stripeIndex: 19 },
    { note: "G5", polygon: [[287, 138.5], [298, 140], [313.5, 157], [302.5, 156]], segment: "right", stripeIndex: 20 },
    { note: "Ab5", polygon: [[298, 140], [308.5, 141.5], [324, 158], [313.5, 157]], segment: "right", stripeIndex: 21 },
    { note: "A5", polygon: [[308.5, 141.5], [318.5, 142.5], [334.5, 159], [324, 158]], segment: "right", stripeIndex: 22 },
    { note: "Bb5", polygon: [[318.5, 142.5], [328.5, 143.5], [345.5, 160], [334.5, 159]], segment: "right", stripeIndex: 23 },
    { note: "B5", polygon: [[328.5, 143.5], [339, 144.5], [355.5, 161], [345.5, 160]], segment: "right", stripeIndex: 24 },
    { note: "C6", polygon: [[339, 144.5], [349, 145.5], [366.5, 162], [355.5, 161]], segment: "right", stripeIndex: 25 },
